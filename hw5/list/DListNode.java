...
public class DListNode extends ListNode {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    //   new node.
    ((DListNode)next()).prev = ((DList) myList).newNode(item,((DList)myList),this,this.next);
    this.next = ((DListNode)next()).prev;
    myList.size++;
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    //   what DList it's in.  You should use myList.newNode() to create the
    //   new node.
    ((DListNode)prev()).next = ((DList)myList).newNode(item,((DList)myList),this.prev,this);
    this.prev = ((DListNode)prev()).next;
    myList.size++;
  }
  ...
  public void remove() throws InvalidNodeException {
    ...
    ((DListNode)prev()).next = next;
    ((DListNode)next()).prev = prev;
    myList.size--;
